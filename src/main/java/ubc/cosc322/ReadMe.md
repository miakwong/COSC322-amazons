# How To Use
1. Make sure you have Java (I use SE21) and maven installed make sure maven has a PATH variable in system varibles
2. Make sure you are using a newer version of java maven seems to default to 1.8
...
3. Make sure you are on the university wifi (secure not the public one) or the ubc vpn through cisco
4. Run this command
